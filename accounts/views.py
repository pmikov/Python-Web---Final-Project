...
class UserProfileView(views.UpdateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["recipes"] = self.get_object().recipes_set.all()
        context["own_profile"] = self.request.user.username == context["profile_user"].username
        context["admin"] = self.request.user.username == "admin"
        return context
